...
Note that **you can also use `=` as an assignment operator** (like in other programming languages!), but because that symbol can have other meanings, we recommend sticking with the `<-` combination.
:::
