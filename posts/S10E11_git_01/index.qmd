...
We are continuing one of this semester's Code Club series on reproducible research. Since we started this at the beginning of the semester and now its mid-November let's recap. So far, we have gone through:


1. [An intro to Quarto](https://osu-codeclub.github.io/posts/S10E01_reprod_01/)
2. [A little more about Quarto](https://osu-codeclub.github.io/posts/S10E02_reprod_02/)
3. [File organization and RStudio projects](https://osu-codeclub.github.io/posts/S10E03_reprod_03/)
4. [Code structuring](https://osu-codeclub.github.io/posts/S10E04_reprod_04/)
5. [Code styling](https://osu-codeclub.github.io/posts/S10E05_reprod_05/)
...
:::callout-note
If you've been here all semester, you will already have created a GitHub account to enable GitHub Copilot in RStudio.
:::
...
We are going to interface with GitHub via Github Desktop because I think this is the easiest way to do so. It is definitely not the only way.
...
# Create a new Project which will become tracked and we will eventually share

I would recommend making a new R Project here as you probably don't want to share all the stuff in the Code Club project you're currently using.

We can do that by going to `File` > `New Project`. I am going to start one in a `New Directory`. 

:::callout-tip
You can use an existing Project as the source for what you plan to put on GitHub too, in fact this would be the more common situation for real material.
:::

# Render a GitHub flavored markdown (GFM) document to prepare to push

We need some material to put in our new repository. We can use the [some old code club code](https://osu-codeclub.github.io/posts/S08E08_reprod_03/), you can download a `.qmd` file to work from [here](https://github.com/osu-codeclub/osu-codeclub.github.io/blob/main/posts/S10E11_git_01/factbook_20251117.qmd).
...
:::callout-note
Why use GitHub flavored markdown? What's nice about it is that your code and output will all be immediately viewable on GitHub. You could push a Quarto or  RMarkdown document, or one of these files that has been rendered (so now its a `.html`) and those files will be downloadable from GitHub but not viewable in your browser online.
:::
