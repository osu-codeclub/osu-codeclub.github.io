...
A very common error recieved at this step is a "dependency" issue. We have found that during testing, inserting function calls (using the function to produce data) within the R script declaring your function leads to this issue... See the below error troubleshooting tip from previous sessions:
