...
A common error from previous weeks surrounds dependency errors - when a package is needed but not called/referenced. If this occurs, ensure that there are no function calls in your R scripts and that every script declares 1 function! See the previous trouble shooting tip from other sessions:
