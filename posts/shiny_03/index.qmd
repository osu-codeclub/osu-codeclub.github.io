...
![Different parameters from Ohio, Pennsylvania, and Indiana in an interactive map.](img/Application%20screenshot.png)

## Building our Shiny App.

Let's make a `shiny` app and see how this works!

First [download the following files](https://github.com/osu-codeclub/osu-codeclub.github.io/tree/main/posts/shiny_03/data/map_data) and set it to a working directory.
