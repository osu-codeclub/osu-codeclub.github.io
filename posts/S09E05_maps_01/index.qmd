...
- Plot maps of various regions, learn how to format them,
  and **add points/markers and text** (part I, today)
...
We have used this to make scatterplots, but it can plot custom, single points too.
...
in which we specify the text we want to print using the `label` argument ---
