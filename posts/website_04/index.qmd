...
How can you make that happen for your website?
**You can do so by giving your GitHub repo the name `<github-username>.github.io`.**

So, for whoever would like to have the shorter URL format,
...
{{< fa user-edit >}} In your GitHub repository, click "Settings":
...
After you've typed the new name, click the "Rename" button:
