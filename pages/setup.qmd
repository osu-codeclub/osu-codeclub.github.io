...
However, you should then have an OSU application on your computer that allows you
to install a selection of approved software, which includes R and RStudio.
On Windows, this app seems to be simply called "Software Center",
whereas on Mac, it is called "Ohio State Application Self Service" (names likely
vary).

If you can't find that application, or have trouble installing R and RStudio this
way, you should contact OSU IT to help you.
:::
